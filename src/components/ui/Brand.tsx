export function ForgeMark({ className = 'h-7 w-7' }: { className?: string }) {
  return (
    <span className={`flex items-center justify-center rounded-md bg-gradient-to-b from-forge-400 to-forge-600 shadow-[0_0_16px_-4px_rgba(255,76,0,0.6)] ${className}`}>
